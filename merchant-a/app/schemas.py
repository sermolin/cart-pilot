"""Pydantic schemas for Merchant A API.

Defines request/response models for products, checkout, and webhooks.
"""
...
class CheckoutSchema(BaseModel, UCPMixin):
    ...
    merchant_order_id: str | None = Field(None, description="Merchant order ID after confirmation")
